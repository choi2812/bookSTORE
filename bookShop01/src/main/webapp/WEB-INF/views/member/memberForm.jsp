...
var compareCheck_pwd = false;
function compare_pwd() {
	var pwd = $('#member_pw1').val();
	var pwdCheck = $('#member_pw2').val();
	
	if(pwd == pwdCheck){
		compareCheck_pwd = true;
		$('#checkResult').text('비밀번호가 일치합니다');		
	} else {
		compareCheck_pwd = false;
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
						<input name="member_pw_check" id="member_pw2" type="password" size="20" onkeyup="compare_pwd()"/>
						<span style="font-size:8px" id="checkResult">비밀번호를 올바르게 입력하세요</span>
					</td>
				</tr>
				<tr class="dot_line">
